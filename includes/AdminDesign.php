...
final class AdminDesign
{
    ...
    public static function render(string $html, Engine $engine, string $platform): string
    {
        ...
        $out.='<nav class="wd-nav" aria-label="Sections du connecteur"><a href="#wd-licence">Licence</a><a href="#wd-settings">Réglages</a><a href="#wd-tools">Actions &amp; maintenance</a><a href="#wd-reports">Rapports &amp; diagnostics</a></nav><div class="wd-stats">';
        ...
        foreach($sections as $name=>$content){
            ...
            $open=in_array($name,['settings','Diagnostics'],true)||($name==='Modifier les champs personnalisés'&&in_array((string)($_POST['bridge_action']??''),['load_mirror_fields','save_mirror_fields'],true))||($name==='Champs personnalisés'&&($_POST['bridge_action']??'')==='save_field_rows');
